...
@javax.annotation.Generated(
    ...
    comments = "Source: com/exchange/proto/ledger/account_service.proto")
public final class AccountServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.exchange.proto.ledger.account.CreateAccountRequestPb,
      com.exchange.proto.ledger.account.CreateAccountReplyPb> getCreateAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createAccount",
      requestType = com.exchange.proto.ledger.account.CreateAccountRequestPb.class,
      responseType = com.exchange.proto.ledger.account.CreateAccountReplyPb.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.exchange.proto.ledger.account.CreateAccountRequestPb,
      com.exchange.proto.ledger.account.CreateAccountReplyPb> getCreateAccountMethod() {
    io.grpc.MethodDescriptor<com.exchange.proto.ledger.account.CreateAccountRequestPb, com.exchange.proto.ledger.account.CreateAccountReplyPb> getCreateAccountMethod;
      ...
      synchronized (AccountServiceGrpc.class) {
        if ((getCreateAccountMethod = AccountServiceGrpc.getCreateAccountMethod) == null) {
          AccountServiceGrpc.getCreateAccountMethod = getCreateAccountMethod =
              io.grpc.MethodDescriptor.<com.exchange.proto.ledger.account.CreateAccountRequestPb, com.exchange.proto.ledger.account.CreateAccountReplyPb>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exchange.proto.ledger.account.CreateAccountRequestPb.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exchange.proto.ledger.account.CreateAccountReplyPb.getDefaultInstance()))
  ...
  public static abstract class AccountServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createAccount(com.exchange.proto.ledger.account.CreateAccountRequestPb request,
        io.grpc.stub.StreamObserver<com.exchange.proto.ledger.account.CreateAccountReplyPb> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.exchange.proto.ledger.account.CreateAccountRequestPb,
                com.exchange.proto.ledger.account.CreateAccountReplyPb>(
  ...
  public static final class AccountServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountServiceBlockingStub> {
    ...
    /**
     */
    public com.exchange.proto.ledger.account.CreateAccountReplyPb createAccount(com.exchange.proto.ledger.account.CreateAccountRequestPb request) {
  ...
  public static final class AccountServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AccountServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exchange.proto.ledger.account.CreateAccountReplyPb> createAccount(
        com.exchange.proto.ledger.account.CreateAccountRequestPb request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ACCOUNT:
          serviceImpl.createAccount((com.exchange.proto.ledger.account.CreateAccountRequestPb) request,
              (io.grpc.stub.StreamObserver<com.exchange.proto.ledger.account.CreateAccountReplyPb>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.exchange.proto.ledger.account.AccountServiceOuterClass.getDescriptor();
    }
