...
public final class PostServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.proto.ledger.post.PostTransactionRequestPb,
      com.example.proto.ledger.post.PostTransactionReplyPb> getPostTransactionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "postTransaction",
      requestType = com.example.proto.ledger.post.PostTransactionRequestPb.class,
      responseType = com.example.proto.ledger.post.PostTransactionReplyPb.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.proto.ledger.post.PostTransactionRequestPb,
      com.example.proto.ledger.post.PostTransactionReplyPb> getPostTransactionMethod() {
    io.grpc.MethodDescriptor<com.example.proto.ledger.post.PostTransactionRequestPb, com.example.proto.ledger.post.PostTransactionReplyPb> getPostTransactionMethod;
      ...
      synchronized (PostServiceGrpc.class) {
        if ((getPostTransactionMethod = PostServiceGrpc.getPostTransactionMethod) == null) {
          PostServiceGrpc.getPostTransactionMethod = getPostTransactionMethod =
              io.grpc.MethodDescriptor.<com.example.proto.ledger.post.PostTransactionRequestPb, com.example.proto.ledger.post.PostTransactionReplyPb>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "postTransaction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.proto.ledger.post.PostTransactionRequestPb.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.proto.ledger.post.PostTransactionReplyPb.getDefaultInstance()))
  ...
  public static abstract class PostServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void postTransaction(com.example.proto.ledger.post.PostTransactionRequestPb request,
        io.grpc.stub.StreamObserver<com.example.proto.ledger.post.PostTransactionReplyPb> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.proto.ledger.post.PostTransactionRequestPb,
                com.example.proto.ledger.post.PostTransactionReplyPb>(
  ...
  public static final class PostServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PostServiceBlockingStub> {
    ...
    /**
     */
    public com.example.proto.ledger.post.PostTransactionReplyPb postTransaction(com.example.proto.ledger.post.PostTransactionRequestPb request) {
  ...
  public static final class PostServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PostServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.proto.ledger.post.PostTransactionReplyPb> postTransaction(
        com.example.proto.ledger.post.PostTransactionRequestPb request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_POST_TRANSACTION:
          serviceImpl.postTransaction((com.example.proto.ledger.post.PostTransactionRequestPb) request,
              (io.grpc.stub.StreamObserver<com.example.proto.ledger.post.PostTransactionReplyPb>) responseObserver);
          break;
        default:
  ...
  private static abstract class PostServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.proto.ledger.post.PostServiceOuterClass.getDescriptor();
    }
