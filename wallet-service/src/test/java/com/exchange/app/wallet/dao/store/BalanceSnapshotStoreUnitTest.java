...
//                .thenReturn(com.exchange.common.utils.result.Results.success(new CacheValueInfo<>("wallet-1", CacheType.STRING)));
//        when(repository.getByWalletId("wallet-1")).thenReturn(snapshot);
//
//        com.exchange.common.utils.result.Result<BalanceSnapshot> result = store.getByRefId("ref-1");
//
...
//
//        when(balanceSnapshotRefCache.get("ref-miss")).thenReturn(com.exchange.common.utils.result.Results.success());
...
//        when(balanceSnapshotRefCache.setNegative("ref-miss", negativeTtl)).thenReturn(com.exchange.common.utils.result.Results.success());
//
//        com.exchange.common.utils.result.Result<BalanceSnapshot> result = store.getByRefId("ref-miss");
//
//        Assert.assertTrue(result.success());
