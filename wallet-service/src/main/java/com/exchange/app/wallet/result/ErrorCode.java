...
public enum ErrorCode implements PbMappableErrorCode {
    ...
    WALLET_ACTION_MISMATCH(1403, ErrorCodePb.ERROR_INTERNAL, "wallet_action_mismatch"),
    ...
    WALLET_RESERVATION_MISMATCH(1503, ErrorCodePb.ERROR_INTERNAL, "wallet_reservation_mismatch"),
