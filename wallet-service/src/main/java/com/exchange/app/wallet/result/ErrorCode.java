...
public enum ErrorCode implements PbMappableErrorCode {
    ...
    BALANCE_SNAPSHOT_UPDATE_FAILED(1102, ErrorCodePb.ERROR_FAILED_PRECONDITION, "balance_snapshot_update_failed"),
    BALANCE_SNAPSHOT_MISMATCH(1103, ErrorCodePb.ERROR_FAILED_PRECONDITION, "balance_snapshot_mismatch"),
    ...
    WALLET_TRANSACTION_INVALID(1302, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_transaction_invalid"),
    WALLET_TRANSACTION_UPDATE_FAILED(1303, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_transaction_update_failed"),
    ...
    WALLET_ACTION_INVALID(1402, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_action_invalid"),
    WALLET_ACTION_MISMATCH(1403, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_action_mismatch"),
    WALLET_ACTION_UPDATE_FAILED(1403, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_action_update_failed"),
    ...
    WALLET_RESERVATION_INVALID(1502, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_reservation_invalid"),
    WALLET_RESERVATION_MISMATCH(1503, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_reservation_mismatch"),
    WALLET_RESERVATION_UPDATE_FAILED(1504, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_reservation_update_failed"),
    WALLET_RESERVATION_NOT_SATISFIED(1505,ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_reservation_not_satisfied"),
    WALLET_RESERVATION_NOT_AVAILABLE(1506, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_reservation_not_available"),
    WALLET_OUTBOX_DUPLICATED(1600, ErrorCodePb.ERROR_ALREADY_EXISTS, "wallet_outbox_duplicated"),
    WALLET_OUTBOX_UPDATE_FAILED(1601, ErrorCodePb.ERROR_FAILED_PRECONDITION, "wallet_outbox_update_failed"),
